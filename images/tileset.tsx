...
<tileset version="1.8" tiledversion="1.8.0" name="tileset" tilewidth="32" tileheight="32" tilecount="256" columns="16">
 ...
 <wangsets>
  ...
  <wangset name="Grass" type="mixed" tile="-1">
   ...
   <wangcolor name="" color="#55557f" tile="-1" probability="1"/>
   ...
   <wangtile tileid="8" wangid="2,2,2,3,2,2,2,2"/>
   <wangtile tileid="9" wangid="2,2,2,3,3,3,2,2"/>
   <wangtile tileid="10" wangid="2,2,2,2,2,3,2,2"/>
   <wangtile tileid="11" wangid="1,1,1,3,1,1,1,1"/>
   <wangtile tileid="12" wangid="1,1,1,3,3,3,1,1"/>
   <wangtile tileid="13" wangid="1,1,1,1,1,3,1,1"/>
   ...
   <wangtile tileid="24" wangid="2,3,3,3,2,2,2,2"/>
   <wangtile tileid="25" wangid="3,3,3,3,3,3,3,3"/>
   <wangtile tileid="26" wangid="2,2,2,2,2,3,3,3"/>
   <wangtile tileid="27" wangid="1,3,3,3,1,1,1,1"/>
   <wangtile tileid="28" wangid="3,3,3,3,3,3,3,3"/>
   <wangtile tileid="29" wangid="1,1,1,1,1,3,3,3"/>
   ...
   <wangtile tileid="40" wangid="2,3,2,2,2,2,2,2"/>
   <wangtile tileid="41" wangid="3,3,2,2,2,2,2,3"/>
   <wangtile tileid="42" wangid="2,2,2,2,2,2,2,3"/>
   <wangtile tileid="43" wangid="1,3,1,1,1,1,1,1"/>
   <wangtile tileid="44" wangid="3,3,1,1,1,1,1,3"/>
   <wangtile tileid="45" wangid="1,1,1,1,1,1,1,3"/>
  </wangset>
 </wangsets>
</tileset>
